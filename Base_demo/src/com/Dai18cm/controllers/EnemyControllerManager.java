...
public class EnemyControllerManager extends ControllerManager {
    ...
    public void run() {
        ...
        if(GameConfig.getInst().durationInMiliSeconds(count) > TIME_PER_ENEMY_APPEAR){
            ...
            int random_X =
                    rand.nextInt(((GameConfig.DEFAULT_SCREEN_WIDTH /2) - Enemy.DEFAULT_WIDTH - 5)) + 1;// Random vi tri X cua Sperm
            this.singleControllerVector.add(EnemyController.create(random_X, 10));
        }
    }
